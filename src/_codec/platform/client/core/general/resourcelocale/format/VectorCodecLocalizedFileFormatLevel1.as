package _codec.platform.client.core.general.resourcelocale.format
{
    ...
    public class VectorCodecLocalizedFileFormatLevel1 implements ICodec 
    {
        ...
        public function VectorCodecLocalizedFileFormatLevel1(_arg_1:Boolean)
        {
        ...
        {
            this.elementCodec = _arg_1.getCodec(new TypeCodecInfo(LocalizedFileFormat, false));
        ...
        public function decode(_arg_1:ProtocolBuffer):Object
        {
            ...
            var _local_3:Vector.<LocalizedFileFormat> = new Vector.<LocalizedFileFormat>(_local_2, true);
            var _local_4:int;
            while (_local_4 < _local_2)
            {
                _local_3[_local_4] = LocalizedFileFormat(this.elementCodec.decode(_arg_1));
                _local_4++;
            };
            return (_local_3);
        }
        ...
        {
            var _local_4:LocalizedFileFormat;
            if (_arg_2 == null)
            {
                throw (new Error("Object is null. Use @ProtocolOptional annotation."));
            };
            var _local_3:Vector.<LocalizedFileFormat> = Vector.<LocalizedFileFormat>(_arg_2);
